...
public class PriorityQueue<T> {
    ...
    public PriorityQueue<T> add(T object) {
        java.util.PriorityQueue<T> newPq = new java.util.PriorityQueue<T>(this.pq);
        newPq.add(object);
        return new PriorityQueue<T>(newPq);
    }
    ...
    public Pair<Optional<T>, PriorityQueue<T>> poll() {
        java.util.PriorityQueue<T> newPq = new java.util.PriorityQueue<T>(this.pq);
        return Pair.of(Optional.ofNullable(newPq.poll()), new PriorityQueue<T>(newPq));
    }
}
